...
public class SimpleAgent extends Agent {
    ...
    protected void setup() {
        ...
        double[] toPredict = new double[]{35.0,37.0,39.0};
        addBehaviour(new MLROneShot(dataSetAge,toPredict));
        ...
        toPredict = new double[]{10.8,11.1,11.4};
        addBehaviour(new MLRSimple(dataSetSalary,toPredict));
        ...
        double[][] toPredictM = new double[][]{
                {1, 2060, 0.15, 2111367, 0, 45.1, 2.24, 562, 56.7, 926613025, 16.87, 10235033990.0},
                {1, 2070, 0.14, 2411367, -532687, 47.1, 2.24, 568, 58.7, 966613025, 17.87, 10335033990.0},
                {1, 2080, 0.14, 2711367, -471005, 49.1, 2.24, 572, 60.7, 996613025, 16.87, 10435033990.0}
        };
        addBehaviour(new MLRBehaviour(dataSetPopulation,toPredictM));


    }

    private class MLROneShot extends OneShotBehaviour {
        private DataSet dataSet;
        private double[] toPredict;

        public MLROneShot(DataSet dataSet, double[] toPredict) {
        ...
        public void action() {
            ...
            MultipleLinearRegresion mlr = new MultipleLinearRegresion(dataSet);
            System.out.println("\n" + mlr.equation());
            ...
            for (double n :
                ...
                System.out.println("Predict for " + n + ": " + mlr.predict(o));
            }
        }
    ...
    private class MLRSimple extends SimpleBehaviour {
        private DataSet dataSet;
        private double[] toPredict;

        public MLRSimple(DataSet dataSet, double[] toPredict) {
            this.dataSet = dataSet;
            this.toPredict = toPredict;
        }
    ...
    private class MLRBehaviour extends Behaviour {
        ...
        public MLRBehaviour(DataSet dataSet, double[][] toPredict) {
            this.dataSet = dataSet;
            this.toPredict = toPredict;
        }
        ...
        public void action() {
            ...
            for (double[] n :
                    toPredict) {
                System.out.println("Prediction for " + Arrays.toString(n) + ": " + mlr.predict(n));
            }
        }
