...
public class GeneticAlgorithm {
    ...
    private Double[][] ranges;  // Gene ranges
    private Population population;
    private Population recombinedPopulation;
    private DataSet dataSet;

    public GeneticAlgorithm(int populationSize, double crossoverRate, double mutationRate, int elitismCount, DataSet dataSet, Double[][] ranges) {
        this.populationSize = populationSize;
        this.crossoverRate = crossoverRate;
        this.mutationRate = mutationRate;
        this.elitismCount = elitismCount;
        this.dataSet = dataSet;
        this.ranges = ranges;  // Initialize gene ranges
